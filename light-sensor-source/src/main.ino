...
#define MODE "client"
#define PEER "" // By default it scouts for a peer to connect to.
                // Set peer locator here, to connect to explicitly coonect to it
#define URI "/paris/office/gb-jl/luminosity"
